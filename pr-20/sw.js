...
const CACHE = 'swim-buddy-mue6lbi0'
const PRECACHE = [
  "/SwimBuddy/pr-20/assets/index-B_hcUyca.js",
  "/SwimBuddy/pr-20/assets/app-Ajdwmfj8.js",
  "/SwimBuddy/pr-20/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-20/assets/storage-BK-gkpZ7.js",
  "/SwimBuddy/pr-20/assets/index-B0ySuQHi.css",
  "/SwimBuddy/pr-20/favicon.svg",
  "/SwimBuddy/pr-20/manifest.webmanifest",
  "/SwimBuddy/pr-20/icon-192.png",
  "/SwimBuddy/pr-20/icon-512.png",
  "/SwimBuddy/pr-20/icon-512-maskable.png",
  "/SwimBuddy/pr-20/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-20/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
