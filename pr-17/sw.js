...
const CACHE = 'swim-buddy-mudlthe0'
const PRECACHE = [
  "/SwimBuddy/pr-17/assets/index-BvU_QH33.js",
  "/SwimBuddy/pr-17/assets/app-ByqTPptI.js",
  "/SwimBuddy/pr-17/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-17/assets/storage-NUUn04kZ.js",
  "/SwimBuddy/pr-17/assets/index-cEmeqCrz.css",
  "/SwimBuddy/pr-17/favicon.svg",
  "/SwimBuddy/pr-17/manifest.webmanifest",
  "/SwimBuddy/pr-17/icon-192.png",
  "/SwimBuddy/pr-17/icon-512.png",
  "/SwimBuddy/pr-17/icon-512-maskable.png",
  "/SwimBuddy/pr-17/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-17/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
