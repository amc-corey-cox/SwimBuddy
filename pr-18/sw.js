...
const CACHE = 'swim-buddy-mudmgoq7'
const PRECACHE = [
  "/SwimBuddy/pr-18/assets/index-D0eWCaye.js",
  "/SwimBuddy/pr-18/assets/app-D8qLpn91.js",
  "/SwimBuddy/pr-18/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-18/assets/storage-NUUn04kZ.js",
  "/SwimBuddy/pr-18/assets/index-BlBO87YC.css",
  "/SwimBuddy/pr-18/favicon.svg",
  "/SwimBuddy/pr-18/manifest.webmanifest",
  "/SwimBuddy/pr-18/icon-192.png",
  "/SwimBuddy/pr-18/icon-512.png",
  "/SwimBuddy/pr-18/icon-512-maskable.png",
  "/SwimBuddy/pr-18/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-18/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
