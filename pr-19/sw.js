...
const CACHE = 'swim-buddy-mue4924i'
const PRECACHE = [
  "/SwimBuddy/pr-19/assets/index-9GonFI6M.js",
  "/SwimBuddy/pr-19/assets/app-D8qLpn91.js",
  "/SwimBuddy/pr-19/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-19/assets/storage-UKLJZgb-.js",
  "/SwimBuddy/pr-19/assets/index-B0ySuQHi.css",
  "/SwimBuddy/pr-19/favicon.svg",
  "/SwimBuddy/pr-19/manifest.webmanifest",
  "/SwimBuddy/pr-19/icon-192.png",
  "/SwimBuddy/pr-19/icon-512.png",
  "/SwimBuddy/pr-19/icon-512-maskable.png",
  "/SwimBuddy/pr-19/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-19/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
