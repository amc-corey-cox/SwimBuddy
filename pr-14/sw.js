...
const CACHE = 'swim-buddy-mudkyt05'
const PRECACHE = [
  "/SwimBuddy/pr-14/assets/index-DjDcnGwy.js",
  "/SwimBuddy/pr-14/assets/app-ByqTPptI.js",
  "/SwimBuddy/pr-14/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-14/assets/storage-DupahdBa.js",
  "/SwimBuddy/pr-14/assets/index-cEmeqCrz.css",
  "/SwimBuddy/pr-14/favicon.svg",
  "/SwimBuddy/pr-14/manifest.webmanifest",
  "/SwimBuddy/pr-14/icon-192.png",
  "/SwimBuddy/pr-14/icon-512.png",
  "/SwimBuddy/pr-14/icon-512-maskable.png",
  "/SwimBuddy/pr-14/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-14/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
