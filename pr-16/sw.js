...
const CACHE = 'swim-buddy-mudlrm5s'
const PRECACHE = [
  "/SwimBuddy/pr-16/assets/index-RflXLEn9.js",
  "/SwimBuddy/pr-16/assets/app-ByqTPptI.js",
  "/SwimBuddy/pr-16/assets/modifiers-oTsBHyV2.js",
  "/SwimBuddy/pr-16/assets/storage-BSBJcSI7.js",
  "/SwimBuddy/pr-16/assets/index-CzfHj2UB.css",
  "/SwimBuddy/pr-16/favicon.svg",
  "/SwimBuddy/pr-16/manifest.webmanifest",
  "/SwimBuddy/pr-16/icon-192.png",
  "/SwimBuddy/pr-16/icon-512.png",
  "/SwimBuddy/pr-16/icon-512-maskable.png",
  "/SwimBuddy/pr-16/"
]
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    event.respondWith(
      caches.match("/SwimBuddy/pr-16/", MATCH).then((hit) => hit ?? fetch(request)),
    )
    return
  }
